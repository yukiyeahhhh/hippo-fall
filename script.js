...
const STAGE_CONFIG=[
  null,
  {goal:1, mixRows:2, blockRatio:0.25}, // Stage 1: 下2行, ブロック25%
  {goal:2, mixRows:3, blockRatio:0.35}, // Stage 2: 下3行, ブロック35%
  {goal:2, mixRows:4, blockRatio:0.50}, // Stage 3: 下4行, ブロック50%
  {goal:3, mixRows:5, blockRatio:0.62}, // Stage 4: 下5行, ブロック62%
  {goal:3, mixRows:6, blockRatio:0.72}, // Stage 5: 下6行, ブロック72%
];
